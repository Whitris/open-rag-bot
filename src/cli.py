...
def chat(
    ...
    k: int = typer.Option(5, "--top-k", "-k", help="Numero di documenti rilevanti da considerare"),
    ...
    history = [
        {"role": "system", "content": f"Sei un assistente virtuale. Rispondi sempre in {language}."}
    ]
